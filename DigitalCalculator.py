...
input_field = Entry(input_frame, font=("ariel", 18, "bold"), textvariable=input_text, width=50, bg="#eee", bd=0,
                    justify=RIGHT)
...
clear = Button(btns_frame, text="clear", fg="black", width=32, height=3, bg="#eee", cursor="hand2",
               command=lambda: btn_click()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
